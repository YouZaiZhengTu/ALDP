...
# import dendrogram
# from GRINCH.dendrogram import Node
...
class Graph(object):
    ...
    def constr_nearest_neighbor(self, node: Node, exclude: List[Node] = None) \
            -> Union[Node, None]:
        if exclude is None:
            exclude = [node]
    ...
    def get_similarity(self, n1: Union[Node, Node], n2: Union[Node, Node]) -> float:
        t = None
